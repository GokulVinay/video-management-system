  ...
  return (
    <div className='home-container'>
        ...
        <div className='home-card'>
            <div>
                <h4 style={{color:'red'}}>#Repurpose video with AI</h4>
                ...
                <form>
                    <section>
                        ...
                        <input id='link' className='link-input' type='text' placeholder='Paste your video link(YouTube)' onChange={(e)=>seturl(e.target.value)}/>
                    </section>
